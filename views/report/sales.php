...
if (!empty($req->get())) {
    ...
    $select = new database();
    $tbl_invoice1 = $select->query("SELECT sum(total) as total, count(invoice_id) as invoice FROM tbl_invoice WHERE order_date BETWEEN '" . $fromdate . "' AND '" . $todate . "'");
            ...
            <section class="content">
                <div class="card card-success">
                    ...
                    <div class="card-header with-border">
                        <h3 class="box-title" style="font-family: 'Phetsarath OT'; color: #0a58ca">ລາຍງານການຂາຍຕາມວັນທີເດືອນປີ</h3>
                    </div>
                        <div class="card-header with-border">
