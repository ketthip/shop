...
$select = new database();
$warehouses = $select->query("SELECT return_product.*, warehouse.* FROM return_product 
                INNER JOIN warehouse ON return_product.product_code = warehouse.product_code
                 WHERE return_product.product_code=" . $id);
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content">
                <!-- Main content -->
                <form action="<?=url('store_return/edit/save')?>" method="POST" name="form_product" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="box-title" style="font-family: 'Phetsarath OT'">Claim ສິນຄ້າຄືນໃຫ້ໂຮງງານຜະລິດ</h3>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" name="update_product_store">ສົ່ງ Claim</button>
