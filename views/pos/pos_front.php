            ...
            <div class="col-md-7">
                <div class="panel panel-info">
                    <div class="panel-body">
                        <div class="row">
                            <img src="<?= storage('upload/ads.jpg') ?>" alt="Product Image"  height="750px" width="1075px">
                            <!--                            <div class="col-md-7">-->
                            ...
                            <!--                                            <dt><h4>ລາຄາທັງໝົດ:</h4></dt>-->
                            <!--                                            <dd class="text-primary">{{submitCheckout.checkOutTotal | currency:"":0}}</dd>-->
                            <!--                                            <dt><h3>ຮັບເງິນຈາກລູກຄ້າ:</h3></dt>-->
                            <!--                                            <dd class="text-primary" style="font-size: 20px; color: green;">{{submitCheckout.checkOutPay | currency:"":0}}</dd>-->
                            <!--                                            <dt>ສ່ວນລຸດ:</dt>-->
                            ...
                            <!--                                    </div>-->
                            <!--                                <div class="hidden" id="JQk">-->
                            <!--                                    <div class="col-md-3 text-right"><div class="check"></div></div>-->
                            <!--                                    <div class="col-md-9"><h4>ສຳເລັດ</h4></div>-->
                            <!--                                </div>-->
                            <!--                            </div>-->
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-success btn-block" type="button" id="JQFinish" ng-click="finishOut()" disabled><strong>ສຳເລັດແລ້ວ</strong></button>
                            </div>
                        </div>
                    </div>
                </div>
